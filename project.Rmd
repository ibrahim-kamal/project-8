...
```{r,eval=FALSE}
# get rf accuracy
acc_1 <- (table(pred_1 == testSet)[2]/length(pred_1))[[1]]
# get glm accuracy
acc_2 <- (table(pred_2 == testSet)[2]/length(pred_1))[[1]]
# get gam accuracy
acc_3 <- (table(pred_3 == testSet)[2]/length(pred_1))[[1]]
# get combine classification accuracy
acc_All <- (table(pred_All == testSet)[2]/length(pred_1))[[1]]
```
